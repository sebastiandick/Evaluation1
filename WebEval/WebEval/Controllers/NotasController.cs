...
namespace WebEval.Controllers
{
    public class NotasController : Controller
    {
        ...
        // GET: Notas/Details/5
        public ActionResult Details(TypeSubject id)
        {
            if (id == null)
            {
        ...
        public ActionResult Create([Bind(Include = "Subject,Grades,State")] Nota nota)
        {
        ...
        // GET: Notas/Edit/5
        public ActionResult Edit(TypeSubject id)
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Subject,Grades,State")] Nota nota)
        {
            if (ModelState.IsValid)
            {
